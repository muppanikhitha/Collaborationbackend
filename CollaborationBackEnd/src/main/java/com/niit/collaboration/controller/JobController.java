...
public class JobController {
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/jobs 					//working
	 * 
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/job/ 					//working
	 * 
	 * @param job
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/job/{id} 					//working
	 * 
	 * @param id
	 * @param job
	 * @return
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/getMyAppliedJobs
	 * 
	 * @param httpSession
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/callForInterview/{userId}/{jobId}
	 * @param userId
	 * @param jobId
	...
	public ResponseEntity<Job> callForInterview(@PathVariable("userId") String userId,
		...
		if (jobDAO.updateJobApplication(jobApplication) == false) {
			job.setErrCode("404");
			job.setErrMessage("Not able to change job application status 'call for interview'...");
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/rejectJobApplication/{userId}/{jobId}
	 * @param userId
	 * @param jobId
	 * @param jobApplication
	 * @return
	...
	public ResponseEntity<Job> rejectJobApplication(@PathVariable("userId") String userId,
		...
		if (jobDAO.updateJobApplication(jobApplication) == false) {
			job.setErrCode("404");
			job.setErrMessage("Not able to reject the application...");
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/listVacantJobs //working
	 * 
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/jobApplied
	 * 
	 * @param jobApplication
	 * @param httpSession
	 * @return
