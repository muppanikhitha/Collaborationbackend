...
public class BlogController {
	...
	/**
	 * 	http://localhost:8020/CollaborationFrontEnd/blogs			//working
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/blog/			//working
	 * @param blog
	 * @param session
	 * @return
	 */
	...
	public ResponseEntity<Blog> createBlog(@RequestBody Blog blog, HttpSession session) {
		...
		blog.setErrMessage("Blog already exist with id : " +blog.getId());
		log.error("Blog already exist with id : " +blog.getId());
		return new ResponseEntity<Blog>(HttpStatus.OK);
	}

	/**
	 * 	http://localhost:8020/CollaborationFrontEnd/blog/{id}			//working
	 * @param id
	 * @param blog
	 * @return
	 */
	...
	public ResponseEntity<Blog> updateBlog(@PathVariable("id") int id, @RequestBody Blog blog) {
		...
		if(blogDAO.get(id) == null) {
			blog = new Blog();
			blog.setErrMessage("No blog exist with id : " +blog.getId());
	...
	public ResponseEntity<Blog> deleteBlog(@PathVariable("id") int id) {
		...
		if(blog == null) {
			blog = new Blog();
			blog.setErrMessage("No blog exist with id : " + id);
