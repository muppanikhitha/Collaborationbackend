...
public class FriendController {
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/myFriends			//working
	 * @param session
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/friend/{id}				//working
	 * @param id
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/newFriendRequests			//working
	 * @param session
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/addFriend/{friendId}			//working
	 * @param friendId
	 * @param session
	 * @return
	 */
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/rejectFriend/{id}					//working
	 * @param id
	 * @param friend
	 * @param session
	 * @return
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/acceptFriend/{id}						//working
	 * @param id
	 * @param friend
	 * @param session
	 * @return
	...
	/**
	 * http://localhost:8020/CollaborationFrontEnd/user/unFriend/{id}						//working
	 * @param id
	 * @param friend
	 * @param session
	 * @return
